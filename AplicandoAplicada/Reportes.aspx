...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <link href="App_Themes/Tema1/Reportes.css" rel="stylesheet" />
    ...
    <form id="form1" runat="server" class="FormDetalleReporte">
        ...
        <div class="contenidoprincipal">
            ...
            <h3>Reportes por tipo Empleado</h3>
                ...
                <asp:SqlDataSource ID="tipodeempelados" runat="server" ConnectionString="<%$ ConnectionStrings:aplicadaBDConnectionString %>" SelectCommand="SELECT * FROM [tipo] WHERE (([id_tipo] = 1) OR ([id_tipo] = 2) OR ([id_tipo] = 3))">
                </asp:SqlDataSource>
